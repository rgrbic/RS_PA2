---
title: 'Analysis of severe weather events impact on communities'
output:
  html_document:
    keep_md: yes
---
...
```{r dataEconomy, echo = TRUE, cache=TRUE}
